...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-[#1b2433]">
      {/* Left Branding Panel */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#EC402A]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6">
        <Card className="w-full max-w-md bg-[#1b2433] border-t-4 border-[#EC402A]">
          <CardContent className="p-6 sm:p-8">
            ...
            <div className="space-y-5">
              ...
              {/* Submit Button */}
              <Button
                className="w-full text-white font-medium bg-[#EC402A]"
                onClick={handleLogin}
